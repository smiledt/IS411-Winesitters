...
urlpatterns = [
    ...
    #/wine_recipes patterns, this one will be the final
    path('', views.index, name='index'),
    path('my_ingredients/', views.my_ingredients,
         name='my_ingredients'),  # Lists a users ingredients
    ...
    path('landing_page/', views.land, name='land'),
    # path('ingredients/', views.ingredients,
    #      name='ingredients'),  # Lists all ingredients
